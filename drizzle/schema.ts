...
export const gamePiece = pgEnum("game_piece", [
  "PAWN",
  "KNIGHT",
  "BISHOP",
  "ROOK",
...
export const gameResult = pgEnum("game_result", [
  "WHITE_WIN",
  "BLACK_WIN",
  "DRAW",
...
export const moveType = pgEnum("move_type", [
  ...
  "RESIGNATION_MOVE",
  "STALEMATE_MOVE",
  "THREEFOLD_REPETITION_MOVE",
  "FIFTY_MOVE_RULE_MOVE",
  "AGREEMENT_MOVE",
]);
...
export const roles = pgTable(
  ...
  (table) => [unique("roles_rolename_unique").on(table.rolename)],
);
